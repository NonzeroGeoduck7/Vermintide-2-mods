...
local event_summary_frame_size = {
	game_option_size[1],
	window_size[2] - (80 + 3*play_button_size[2] + game_option_size[2])
}
...
local adventure_scenegraph_definition = {
	root = {
		is_root = true,
		size = {
			1920,
	...
	local widget = {
		...
		style = {
			...
			background = {
				...
				offset = {
					0,
					-10, -- change reward image offset here
					0
				}
			},
			title_bg = {
...
local adventure_widgets = {
	background_fade = UIWidgets.create_simple_texture("options_window_fade_01", "window"),
	window = UIWidgets.create_frame("window", window_size, window_frame, 20),
	play_button = UIWidgets.create_play_button("play_button", adventure_scenegraph_definition.play_button.size, Localize("start_game_window_play"), 34),
	game_option_difficulty = create_settings_option("game_option_difficulty", adventure_scenegraph_definition.game_option_difficulty.size, Localize("start_game_window_difficulty"), Localize("start_game_window_change_difficulty"), "difficulty_option_1", "game_options_bg_02"),
	game_option_reward = create_reward_presentation("game_option_reward", adventure_scenegraph_definition.game_option_reward.size),
...
local function other_options_widgets(scenegraph_definition)
	
	private_button_text = ''
	if script_data["eac-untrusted"] then
		private_button_text = Localize("start_game_window_other_options_private")
	else
		private_button_text = "PRIVATE (MODDED REALM ONLY)"
	end
	...
	return {
		...
		private_button = UIWidgets.create_default_checkbox_button("private_button", scenegraph_definition.private_button.size, private_button_text, 24, {
			title = Localize("start_game_window_other_options_private"),
			description = Localize("start_game_window_other_options_private_description").."\nPrivate Quick Play games are only allowed in modded realm."
		}),
...
adventure_definitions = {
	widgets = adventure_widgets,
	other_options_widgets = other_options_widgets(adventure_scenegraph_definition),
	scenegraph_definition = adventure_scenegraph_definition,
...
local event_scenegraph_definition = {
	root = {
		is_root = true,
		size = {
			1920,
...
local event_description_text_style = {
	word_wrap = true,
	font_size = 22,
	localize = false,
	use_shadow = true,
...
local event_widgets = {
	...
	window = UIWidgets.create_frame("window", window_size, window_frame, 20),
	event_summary_frame = UIWidgets.create_background_with_frame("event_summary_frame", event_scenegraph_definition.event_summary_frame.size, "game_options_bg_04", "menu_frame_08", true),
...
event_definitions = {
	...
	other_options_widgets = other_options_widgets(event_scenegraph_definition),
	scenegraph_definition = event_scenegraph_definition
}
